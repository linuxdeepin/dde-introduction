    ...
    : QScrollArea(parent)
{
    ...
    const QString &text = QString("<body>"
            ...
            .arg(tr("The donation aims to make a survey and decide the orientation and proirity of the projects, support the continuous further development, and support community activities and construction."))
            .arg(tr("Internal Testing"))
            .arg(tr("For quality assurance of the deepin project, we welcome more people to participate in the internal testing and feedback tracking. Become a Internal Testing Team member, you will"))
